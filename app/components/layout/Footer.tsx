    ...
    <footer className="relative mt-20 overflow-hidden">
      ...
      <Section className="relative py-12">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          >
            <SocialIcon href="#" icon={FaWhatsapp} label="WhatsApp" delay={0} />
            <SocialIcon href="#" icon={Facebook} label="Facebook" delay={0.1} />
            <SocialIcon href="#" icon={Instagram} label="Instagram" delay={0.2} />
            <SocialIcon href="#" icon={FaTiktok} label="TikTok" delay={0.3} />
          </motion.div>
